...
public class MazeSearchDisplayExtension {
    JFrame win;
    protected AbstractMazeSearchExtension searcher;
     ...
     */
    public MazeSearchDisplayExtension(AbstractMazeSearchExtension searcher, int scale) {
        // setup the window
    ...
    public void setMazeSearch(AbstractMazeSearchExtension searcher) {
        this.searcher = searcher;
    }
